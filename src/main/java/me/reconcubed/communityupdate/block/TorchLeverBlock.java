...
public class TorchLeverBlock extends LeverBase {
    ...
    public TorchLeverBlock(Properties properties) {
        super(properties);
    }
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos blockPos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (worldIn.isRemote) {
            ...
            worldIn.playSound((PlayerEntity) null, blockPos, SoundEvents.BLOCK_LEVER_CLICK, SoundCategory.BLOCKS, 0.3F, f);
